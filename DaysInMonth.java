...
public class DaysInMonth {
    ...
    public static int getMonthNumber(String monthInput) {
        ...
        switch (monthInput) {
            ...
            case "12":
                return 12;
            default:
                return -1; // Tháng không hợp lệ (Lấy số âm cho đỡ bị trùng trường hợp)
        }
    }
    ...
    public static void main(String[] args) {
        ...
        while (month == -1) {
            ...
            if (monthInput == null) { // Nếu người dùng nhấn Cancel
                System.exit(0);
            }
        ...
        while (year < 0) {
            ...
            if (yearInput == null) { // Nếu người dùng nhấn Cancel
                System.exit(0);
            }
